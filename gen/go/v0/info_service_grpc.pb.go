...
func (c *infoServiceClient) GiveToolInfo(ctx context.Context, in *GiveToolInfoRequest, opts ...grpc.CallOption) (*ServiceStatusResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(ServiceStatusResponse)
	err := c.cc.Invoke(ctx, InfoService_GiveToolInfo_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (UnimplementedInfoServiceServer) GiveToolInfo(context.Context, *GiveToolInfoRequest) (*ServiceStatusResponse, error) {
	return nil, status.Error(codes.Unimplemented, "method GiveToolInfo not implemented")
}
...
func _InfoService_GiveToolInfo_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(GiveToolInfoRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(InfoServiceServer).GiveToolInfo(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: InfoService_GiveToolInfo_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(InfoServiceServer).GiveToolInfo(ctx, req.(*GiveToolInfoRequest))
	}
...
var InfoService_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		{
			MethodName: "GiveToolInfo",
			Handler:    _InfoService_GiveToolInfo_Handler,
		},
	},
	Streams:  []grpc.StreamDesc{},
	Metadata: "info_service.proto",
}
