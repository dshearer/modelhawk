...
// @generated from protobuf file "application.proto" (package "modelhawk.v1", syntax proto3)
// tslint:disable
...
class Application$Type extends MessageType<Application> {
    constructor() {
        super("modelhawk.v1.Application", [
...
/**
 * @generated MessageType for protobuf message modelhawk.v1.Application
 */
